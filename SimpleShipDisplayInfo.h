...
template<typename T>
SimpleShipDisplayInfo<T>::SimpleShipDisplayInfo(T _myData, T _onHit):myData(_myData), onHit(_onHit){}

template<typename T>
std::unique_ptr<T> SimpleShipDisplayInfo<T>::getInfo(Coordinate where, bool hit){
