...
public:
    ...
    std::unordered_map<T, size_t> sonarScanning(Coordinate c);
...
//}
template<typename T>
int BattleShipBoard<T>::getWidth() { return width; }

template<typename T>
int BattleShipBoard<T>::getHeight() { return height; }
...
template<typename T>
std::unordered_map<T, size_t> BattleShipBoard<T>::sonarScanning(Coordinate c) {
